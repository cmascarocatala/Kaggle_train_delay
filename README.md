...
## Dades utilitzades
Dataset descarregat desde https://www.kaggle.com/datasets/ravisingh0399/train-delay-dataset

## Utilització
Descarregar el dataset i el jupyter notebook en un directori amb kernel executable.

## Procediment i resultats
Consultar l'informe adjunt en el repositori, on s'analitza el pocediment, la
neteja de dades, els resultats obtinguts i la seva interpretació.

## Autores
Catalina Mascaró Català - 1708159 i  Mathilde Buffard - 1775251